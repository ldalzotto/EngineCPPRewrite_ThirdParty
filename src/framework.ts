...
namespace el {
    ...
    export const div = function (p_parent_element: HTMLElement, p_input: CreateElementInput): HTMLElement {
        return this.create_element(p_parent_element, "div", p_input);
    };
...
namespace bind {
    export class Binding<Type> {
        ...
        constructor(p_val?: Type, p_on_change_callback?: (arg0: Type, arg1: Type) => void) {
            this.val = p_val; this.on_change_callback = p_on_change_callback;
        };
